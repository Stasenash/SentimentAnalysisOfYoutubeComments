    ...
    try:
        ...
        with io.open(output, 'w', encoding='utf8') as fp:
            for comment in download_comments(youtube_id):
                ...
                if total:
                    sys.stdout.write(f'id_video = {youtube_id} | downloaded: {round((count/total)*100, 2)}% | {count} [{total}, limit={limit}] comment(s)  ' + '\n')
                else:
                    sys.stdout.write(f'id_video = {youtube_id} | downloaded: {count} comment(s)' + '\n')
